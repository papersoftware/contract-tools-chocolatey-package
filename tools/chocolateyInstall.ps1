...
$packageArgs = @{
  ...
  fileType       = 'MSI'
  url            = 'https://papersoftware.s3.amazonaws.com/PaperSoftwareContractTools-1.37.6.0.msi'
  checksum       = '4e7f63a4b3ad4bfc7ef1183d22327c690ec29e33396ac0aa94716f2e5f54b292'
  checksumType   = 'sha256'

...
$packageArgs = @{
  ...
  fileType       = 'MSI'
  url            = 'https://papersoftware.s3.amazonaws.com/PaperSoftwareContractTools-1.37.9.0.msi'
  checksum       = 'a2a9b2976fca615ca89cf5deebed37cf7162f13e91cb8ca713c735948bc77399'
  checksumType   = 'sha256'

...
$packageArgs = @{
  ...
  fileType       = 'MSI'
  url            = 'https://papersoftware.s3.amazonaws.com/PaperSoftwareContractTools-1.37.3.0.msi'
  checksum       = 'ff212fbbfa563706f9783262b715b42d523abfdf8104e99ab42d2ee2006eb6dd'
  checksumType   = 'sha256'

...
$packageArgs = @{
  ...
  fileType       = 'MSI'
  url            = 'https://papersoftware.s3.amazonaws.com/PaperSoftwareContractTools-1.37.8.0.msi'
  checksum       = 'a954bdfb336b339bbba15f21490658e4164b30d4d51a05292119804896e64558'
  checksumType   = 'sha256'
